...
func (r *publicPortalRepo) CheckOrderStatus(ctx context.Context, orderNo, authType, identifier string) (*portalBiz.OrderStatusInfo, string, error) {
	...
	if err != nil {
		...
		subscribe = &portalBiz.SubscribeInfo{
			...
			ShortDescription:  subscribeEntity.ShortDescription,
			Features:          subscribeEntity.Features,
			DetailFormat:      subscribeEntity.DetailFormat,
			DetailContent:     subscribeEntity.DetailContent,
